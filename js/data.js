...
const FLEX_ITEMS = {
  cars: [
    ...
    { id: "car10", name: "JDM Tuner", cost: 38000, heatReduction: 0.04, payoutBoost: 0.015 },
    { id: "car3", name: "Sports Coupe", cost: 42000, heatReduction: 0.06, payoutBoost: 0.03 },
    { id: "car6", name: "Pickup Truck", cost: 48000, heatReduction: 0.03, payoutBoost: 0.02 },
    { id: "car11", name: "Muscle Car", cost: 52000, heatReduction: 0.035, payoutBoost: 0.025 },
    { id: "car7", name: "Luxury Sedan", cost: 120000, heatReduction: 0.05, payoutBoost: 0.04 },
    { id: "car8", name: "Supercar", cost: 280000, heatReduction: 0.07, payoutBoost: 0.055 },
    ...
    { id: "car9", name: "Hypercar", cost: 3500000, heatReduction: 0.13, payoutBoost: 0.11 },
    { id: "car12", name: "Track Hypercar", cost: 4200000, heatReduction: 0.14, payoutBoost: 0.12 },
  ],
  watches: [
    ...
    { id: "watch6", name: "Chronograph", cost: 6000, repBoost: 0.05, payoutBoost: 0.01 },
    { id: "watch10", name: "Two-Tone Datejust", cost: 10000, repBoost: 0.055, payoutBoost: 0.015 },
    { id: "watch7", name: "Dive Watch", cost: 14000, repBoost: 0.06, payoutBoost: 0.02 },
    { id: "watch3", name: "Diamond Rolex", cost: 35000, repBoost: 0.07, payoutBoost: 0.03 },
    { id: "watch8", name: "Royal Oak", cost: 45000, repBoost: 0.08, payoutBoost: 0.035 },
    { id: "watch9", name: "Nautilus", cost: 120000, repBoost: 0.09, payoutBoost: 0.045 },
    { id: "watch11", name: "RM Carbon Skeleton", cost: 180000, repBoost: 0.095, payoutBoost: 0.048 },
    ...
    { id: "watch12", name: "RM Tourbillon", cost: 850000, repBoost: 0.17, payoutBoost: 0.09 },
    { id: "watch13", name: "RM Skull Edition", cost: 1200000, repBoost: 0.2, payoutBoost: 0.1 },
  ],
  necklaces: [
...
const HOUSES = {
  rent: [
    ...
    { id: "rent4", name: "Luxury High-Rise", rentCost: 8000, heatReduction: 0.08, repReq: 400 },
  ],
  buy: [
    { id: "buy1", name: "Suburban House", cost: 450000, taxCost: 500, heatReduction: 0.06, repReq: 0 },
    { id: "buy5", name: "Luxury Condo", cost: 1200000, taxCost: 1200, heatReduction: 0.08, repReq: 100 },
    { id: "buy2", name: "Penthouse Condo", cost: 2500000, taxCost: 2500, heatReduction: 0.1, repReq: 400 },
    { id: "buy6", name: "Beachfront Villa", cost: 6000000, taxCost: 5000, heatReduction: 0.12, repReq: 1000 },
    { id: "buy3", name: "Private Estate", cost: 12000000, taxCost: 8000, heatReduction: 0.15, repReq: 1000 },
    { id: "buy7", name: "Mega Mansion", cost: 25000000, taxCost: 15000, heatReduction: 0.18, repReq: 1800 },
    { id: "buy9", name: "Royal Estate", cost: 35000000, taxCost: 18000, heatReduction: 0.19, repReq: 1800 },
    { id: "buy4", name: "Private Island Compound", cost: 45000000, taxCost: 20000, heatReduction: 0.2, repReq: 1000 },
    { id: "buy8", name: "Sky Penthouse", cost: 80000000, taxCost: 30000, heatReduction: 0.22, repReq: 2500 },
  ],
};
